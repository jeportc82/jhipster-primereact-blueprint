...
describe('Subgenerator entity-client of primereact-blueprint JHipster blueprint', () => {
        ...
        before(done => {
            helpers
                ...
                .withOptions({
                    'from-cli': true,
                    skipInstall: true,
                    blueprint: 'primereact-blueprint',
                    skipChecks: true
                })
                .withGenerators([
                    [
                        require('../generators/entity-client'), // eslint-disable-line global-require
                        'jhipster-primereact-blueprint:entity-client',
